  ...
  return (
    ...
    >
      ...
      {visibleActions.map((action) => {
        ...
        const allowed = allows(action.requires);
        return (
          <div key={action.id} className={styles.row}>
            ...
            <div className={styles.text}>
              ...
              <span className={styles.description}>
                {allowed ? action.description : hintFor(action.requires)}
              </span>
            </div>
            <Button
              className={styles.actionButton}
              disabled={busyId !== null || !allowed}
              title={allowed ? undefined : hintFor(action.requires)}
