      ...
      <main className={styles.main}>
        <div className={styles.wrap}>
          <div className={styles.topbar}>
            <Button href="/video-games" className={styles.backbtn}>
          ...
          {/* The boxes this game belongs to. Read-only: the relationship is
              managed through video game boxes, which have no page yet. */}
          <div className={styles.card}>
            <div className={styles.caphdr}>
              ...
              <ul aria-label="Video game boxes" className={localStyles.boxList}>
                {boxes.map((box) => (
                  <li className={styles.row} key={box.id}>
                    <span className={styles.vText}>{box.title}</span>
                  </li>
                ))}
              </ul>
            )}
